...
export const PartyTime = () => {
      ...
      setTimeout(() => {
        if (location.pathname === '/BounceHouses/SelectPartyTime') {
          navigate('/BounceHouses/CartPage', {
            state: { startTime: startTime, endTime: endTime, selectedDate: selectedDate, name: name, price: price, image: image }
          });
        } else {
  ...
  return (
    <Layout>
      ...
      <div className="flex flex-col justify-center items-center min-h-screen text-white text-center px-4">
        <div className="text-2xl font-bold mb-2 border border-green-50 flex flex-col justify-center items-center w-full md:w-1/2 lg:w-1/3">
          ...
          <div className="flex flex-col justify-center w-full px-4">
            <div className="mb-4">
              <select
                className="w-full md:w-96 border-none h-10 rounded-md text-black font-semibold px-2 text-lg"
                value={startTime}
